...
<!--  <books-modal :api="this.api" :noty="this.noty"></books-modal>-->
  <div class="dialogs-wrap" id="dialogsSpace">
    ...
    <div class="dialog-wrap-dialogs">
      <div class="home">
        <svg class="circle" width="64" height="65" viewBox="0 0 49 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="homes" width="36" height="22" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
